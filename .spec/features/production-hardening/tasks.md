...
## T-001 — Criar gates estruturais de segurança e operação [pendente]
...
## T-002 — Sanear credenciais e exemplos de ambiente [pendente]
...
## T-004 — Tornar o Config Server local e seguro por padrão [pendente]
...
## T-005 — Proteger Gateway e API reativa com JWT [pendente]
...
## T-006 — Modernizar e validar a composição Docker [pendente]
